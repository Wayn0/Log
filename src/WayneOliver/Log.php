 ...
 * $log->log_info('message');                   // logs informational messages
...
class Log
{
    ...
    * Log Level
    **/
    public const FATAL = 1;    // Fatal: Application unstable unusable
    public const ERROR = 2;    // Error: error conditions exist
    public const WARN  = 3;    // Warning: warning conditions
    public const INFO  = 4;    // Info: information messages
    public const DEBUG = 5;    // Debug: debug messages
    public const QUERY = 6;    // Query: log queries too
    public const NONE  = 0;    // No Logging
